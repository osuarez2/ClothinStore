...
public class EditCustomerAcct {


	private JFrame frame;
	private JTable customersTable;

	public EditCustomerAcct() { initialize(); }
	...
	public void createScrollPaneAndTable() {
		...
		scrollPane.setBounds(58, 40, 850, 189);
	...
	public void createEditSelectedButton() {
	    ...
	    editButton.addActionListener(new ActionListener() {
	        public void actionPerformed(ActionEvent e) {
	            ...
	            if (selectedRow == -1) {
	                javax.swing.JOptionPane.showMessageDialog(frame, "Please select a customer to edit.", "No Selection", javax.swing.JOptionPane.WARNING_MESSAGE);
	                return;
	            }
	            ...
	            String currentName = customersTable.getValueAt(selectedRow, 1).toString();
	            String currentEmail = customersTable.getValueAt(selectedRow, 2).toString();
	            String currentPassword = customersTable.getValueAt(selectedRow, 3).toString();
	            String currentAddress = customersTable.getValueAt(selectedRow, 5).toString();
	            ...
	            javax.swing.JTextField addressField = new javax.swing.JTextField(currentAddress);
	            panel.add(addressField);

	            int result = javax.swing.JOptionPane.showConfirmDialog(frame, panel, "Edit Customer", javax.swing.JOptionPane.OK_CANCEL_OPTION, javax.swing.JOptionPane.PLAIN_MESSAGE);
	            ...
	            if (result == javax.swing.JOptionPane.OK_OPTION) {
	                ...
	                try {
	                    String query = "UPDATE users SET user_name = ?, user_email = ?, user_password = ?, user_address = ? WHERE user_id = ?";
	                    PreparedStatement stm = Database.connection.prepareStatement(query);
	                    ...
	                    if (rowsAffected > 0) {
	                        javax.swing.JOptionPane.showMessageDialog(frame, "Customer updated successfully!");
	                        populateTable(); // Refresh table
	                    } else {
	                        javax.swing.JOptionPane.showMessageDialog(frame, "Failed to update customer.", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
	                    }
