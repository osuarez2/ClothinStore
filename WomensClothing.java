...
public class WomensClothing {
    ...
    private JPanel createProductsPage() {
        ...
        JLabel logoLabel = new JLabel("Women's Clothing", SwingConstants.CENTER);
        ...
        try {
            String query = "SELECT item_id, item_name, item_price, item_size, in_stock FROM inventory WHERE dept_id = 2";
    ...
    private void mensButton(JPanel leftPanel) {
        JButton btn = new JButton("Men's Clothing");
        btn.addActionListener(e -> goToMensClothing());
        leftPanel.add(btn);
    }
